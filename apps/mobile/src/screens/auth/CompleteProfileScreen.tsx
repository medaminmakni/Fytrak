...
const styles = StyleSheet.create({
  ...
  card: { backgroundColor: colors.surface, borderRadius: 24, padding: 20, borderWidth: 1, borderColor: colors.surfaceInset, gap: 16 },
  inputGroup: { gap: 8 },
  row: { flexDirection: "row", gap: 12 },
  label: { color: colors.textMuted, fontSize: 14, fontWeight: "700", marginStart: 2 },
  input: { backgroundColor: colors.surfaceInset, borderRadius: 14, paddingHorizontal: 16, paddingVertical: 12, color: "#ffffff", fontSize: 15, fontWeight: "600", borderWidth: 1, borderColor: colors.surfaceInset },
  textArea: { minHeight: 80, textAlignVertical: "top", paddingTop: 12 },
  stepperContainer: { flexDirection: "row", alignItems: "center", backgroundColor: colors.surfaceInset, borderRadius: 14, borderWidth: 1, borderColor: colors.surfaceInset, height: 48, overflow: "hidden" },
  ...
  dateSelector: { flexDirection: "row", alignItems: "center", backgroundColor: colors.surfaceInset, borderRadius: 14, paddingHorizontal: 16, paddingVertical: 12, gap: 12, borderWidth: 1, borderColor: colors.surfaceInset },
  dateText: { color: "#ffffff", fontSize: 15, fontWeight: "600" },
  levelRow: { flexDirection: "row", gap: 8 },
  levelPill: { flex: 1, backgroundColor: colors.surfaceInset, borderRadius: 12, paddingVertical: 12, alignItems: "center", borderWidth: 1, borderColor: colors.surfaceInset },
  ...
  errorText: { color: colors.danger, textAlign: "center", fontSize: 14, fontWeight: "600", marginTop: 10 },
  infoBox: { flexDirection: "row", alignItems: "center", gap: 12, backgroundColor: colors.surface, padding: 16, borderRadius: 20, borderWidth: 1, borderColor: colors.surfaceInset, marginTop: 10 },
