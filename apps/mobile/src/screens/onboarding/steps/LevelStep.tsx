...
const styles = StyleSheet.create({
  ...
  card: { backgroundColor: colors.surface, borderRadius: 24, padding: 24, borderWidth: 1, borderColor: '#333' },
  cardActive: { backgroundColor: '#1a1a10', borderColor: colors.primary, borderWidth: 1.5 },
  row: { flexDirection: 'row', alignItems: 'center', gap: 15 },
  iBox: { width: 50, height: 50, borderRadius: 18, backgroundColor: colors.surface, alignItems: 'center', justifyContent: 'center' },
  info: { flex: 1 },
  bars: { flexDirection: 'row', gap: 4 },
  bar: { width: 10, height: 4, borderRadius: 2, backgroundColor: colors.surface },
