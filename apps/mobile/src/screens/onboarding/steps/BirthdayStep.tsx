...
const styles = StyleSheet.create({
  ...
  dateDisplay: { marginTop: 30, backgroundColor: colors.surface, paddingVertical: 15, borderRadius: 20, alignItems: 'center', borderWidth: 1, borderColor: '#333' },
  ...
  pickerWrapper: { flex: 1, backgroundColor: colors.bg, borderRadius: 20, overflow: 'hidden', borderWidth: 1, borderColor: '#222' },
  indicator: { position: 'absolute', top: INDICATOR_TOP, left: 8, right: 8, height: ITEM_HEIGHT, backgroundColor: colors.surface, borderRadius: 12, borderWidth: 1, borderColor: '#333' },
