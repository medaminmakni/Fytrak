        ...
        <View style={styles.modalContent}>
          <View style={styles.modalHeader}>
            <View>
              ...
              <Typography variant="label" color={colors.textMuted}>Search or enter manually</Typography>
            </View>
                ...
                {results.map((food) => (
                  <Pressable key={food.id} style={styles.searchResultItem} onPress={() => selectFood(food)}>
                    <View style={styles.resultIconBg}>
                      <Ionicons name="fast-food" size={16} color={food.isVerified ? colors.primary : colors.iconFaint} />
                    </View>
                    <View style={{ flex: 1 }}>
...
const styles = StyleSheet.create({
  ...
  modalContent: { backgroundColor: "#000", borderTopLeftRadius: 32, borderTopRightRadius: 32, height: "92%", padding: 24, borderWidth: 1, borderColor: colors.surfaceInset },
  modalHeader: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginBottom: 24 },
  modalTitle: { color: "#fff" },
  closeBtn: { width: 44, height: 44, borderRadius: 14, backgroundColor: colors.surface, alignItems: "center", justifyContent: "center", borderWidth: 1, borderColor: "#222" },
  searchBarWrapper: { flexDirection: "row", alignItems: "center", backgroundColor: colors.bg, borderRadius: 16, paddingHorizontal: 16, height: 56, borderWidth: 1, borderColor: colors.surfaceInset, marginBottom: 12 },
  searchIcon: { marginEnd: 12 },
  loader: { marginStart: 12 },
  input: { flex: 1, color: "#fff", fontSize: 15, fontWeight: "600" },
  searchResultsBox: { backgroundColor: colors.bg, borderRadius: 20, marginBottom: 20, borderWidth: 1, borderColor: colors.surfaceInset, overflow: "hidden" },
  searchResultItem: { flexDirection: "row", alignItems: "center", padding: 14, borderBottomWidth: 1, borderBottomColor: colors.surface, gap: 12 },
  resultIconBg: { width: 36, height: 36, borderRadius: 10, backgroundColor: colors.surface, alignItems: "center", justifyContent: "center" },
  nameRow: { flexDirection: "row", alignItems: "center", gap: 6 },
  resultTitle: { color: "#fff", fontSize: 14, fontWeight: "700" },
  resultSub: { color: colors.textMuted, fontSize: 11, fontWeight: "600" },
  verifiedBadge: { backgroundColor: colors.primary, width: 14, height: 14, borderRadius: 7, alignItems: "center", justifyContent: "center" },
  formSection: { backgroundColor: colors.bg, borderRadius: 24, padding: 20, borderWidth: 1, borderColor: colors.surfaceInset, marginBottom: 20 },
  mealInputRow: { flexDirection: "row", alignItems: "center", gap: 12, borderBottomWidth: 1, borderBottomColor: colors.surface, paddingBottom: 10 },
  mainMealInput: { flex: 1, fontSize: 20, fontWeight: "800", color: "#fff" },
  photoBtn: { width: 44, height: 44, borderRadius: 12, backgroundColor: colors.surface, alignItems: "center", justifyContent: "center", borderWidth: 1, borderColor: "#222" },
  ...
  macroCard: { flex: 1, minWidth: "47%", backgroundColor: colors.surface, borderRadius: 16, padding: 12, borderWidth: 1, borderColor: colors.surfaceInset },
