...
const styles = StyleSheet.create({
  ...
  mealItem: { flexDirection: 'row', alignItems: 'center', backgroundColor: colors.surface, padding: 12, borderRadius: radius.md, marginBottom: 8, borderWidth: 1, borderColor: "#222" },
